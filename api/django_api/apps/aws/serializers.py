...
class AwsCredsSerializer(serializers.Serializer):
    ...
    aws_access_key_en = serializers.CharField(write_only=True, required=False, allow_blank=True)
    aws_access_secret_en = serializers.CharField(write_only=True, required=False, allow_blank=True)
    aws_private_key_pair_pem_en = serializers.CharField(write_only=True, required=False, allow_blank=True)
